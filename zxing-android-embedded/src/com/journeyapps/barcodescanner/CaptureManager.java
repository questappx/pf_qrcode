    ...
    public class CaptureManager {
        ...
        public interface ScanResultListener {
            void onScanBarcodeResult(BarcodeResult result);
...
//                barcodeView.setVisibility(View.GONE);
    ...
    //            handler.post(() -> returnResult(result));
                if (scanResultListener != null) {
                    scanResultListener.onScanBarcodeResult(result);
                }
            }
        ...
        public CaptureManager(Activity activity, DecoratedBarcodeView barcodeView, ScanResultListener scanResultListener) {
            this.activity = activity;
            this.barcodeView = barcodeView;
