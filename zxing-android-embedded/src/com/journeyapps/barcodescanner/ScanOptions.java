...
public class ScanOptions {
    ...
    public static final Collection<String> ALL_CODE_TYPES = list(UPC_A, UPC_E, EAN_8, EAN_13, RSS_14, CODE_39, CODE_93, CODE_128,
            ITF, RSS_EXPANDED, QR_CODE, DATA_MATRIX, PDF_417);
